...
const ARTICLES_EN: Record<string, ArticleText> = {
  ...
  "visa-nomada-digital-panama": {
    title: "Digital Nomad Visa in Panama: requirements and process",
    excerpt: "Panama offers a special visa for remote workers. Here's the full process, costs, and timeline.",
    author: "Expat507 Team",
  ...
  "mejores-bancos-panama-expatriados": {
    ...
    excerpt: "A detailed comparison of the leading banks: English-language service, online banking, and terms for foreigners.",
    author: "Expat507 Team",
    tags: ["banking", "comparison"],
  },
  "mercado-inmobiliario-panama-zonas-clave": {
    title: "Panama's real estate market: key areas to invest in",
    excerpt: "A comparative analysis of the best neighborhoods for real estate investment: Punta Pacífica, Costa del Este, Casco Viejo, and more.",
    author: "Expat507 Team",
  ...
  "fundaciones-interes-privado-panama": {
    ...
    excerpt: "Panamanian foundations are one of the best asset-protection vehicles. A complete guide.",
    author: "Expat507 Team",
  ...
  "planificacion-patrimonial-latinoamericanos-panama": {
    ...
    excerpt: "How to structure your wealth using Panamanian vehicles to protect it from political and tax risks.",
    author: "Expat507 Team",
  ...
  "mejores-barrios-ciudad-de-panama": {
    title: "The best neighborhoods to live in Panama City",
    excerpt: "An honest guide to the most popular neighborhoods among expatriates: pros, cons, and real prices.",
    author: "Expat507 Team",
    tags: ["expat life", "neighborhoods"],
  },
  "sistema-salud-panama-expatriados": {
    title: "Panama's healthcare system: hospitals, insurance, and quality",
