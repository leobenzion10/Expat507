            ...
            resend.emails.send({
              ...
              html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px;">
                  <h2 style="color: #0B1A17;">Nuevo mensaje de contacto</h2>
        ...
        html: `
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="padding: 32px 24px;">
              ...
              <p style="color: #374151; line-height: 1.6;">Si tienes una consulta sobre migración, bienes raíces u otro tema especializado, también puedes explorar nuestras <a href="${SITE_URL}/guias" style="color: #B8935A;">guías</a> o <a href="${SITE_URL}/consulta" style="color: #B8935A;">agendar una consulta gratuita</a>.</p>
            </div>
