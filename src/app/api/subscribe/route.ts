      ...
      locale === "en"
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
          ...
          <div style="padding: 32px 24px;">
            <h2 style="color: #0A1628; margin: 0 0 16px;">Welcome${safeName ? `, ${safeName}` : ""}!</h2>
            ...
            <p style="color: #374151; line-height: 1.6;">While you wait for the next issue, take a look at our <a href="${SITE_URL}/guias" style="color: #C9A84C;">guides</a> or <a href="${SITE_URL}/consulta" style="color: #C9A84C;">book a free consultation</a> if you'd like personalized guidance.</p>
          </div>
      ...
      `
        ...
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #ffffff;">
          ...
          <div style="padding: 32px 24px;">
            ...
            <p style="color: #374151; line-height: 1.6;">Mientras esperas el próximo envío, explora nuestras <a href="${SITE_URL}/guias" style="color: #C9A84C;">guías</a> o <a href="${SITE_URL}/consulta" style="color: #C9A84C;">agenda una consulta gratuita</a> si quieres orientación personalizada.</p>
          </div>
          <div style="background: #F4F6F9; padding: 16px 24px; text-align: center;">
