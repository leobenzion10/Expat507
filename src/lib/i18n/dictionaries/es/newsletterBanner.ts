const newsletterBanner = {
  eyebrow: "Newsletter Exclusivo",
  title: "Información privilegiada, directo a tu inbox",
  subtitle: "Cada semana: análisis del mercado, cambios regulatorios, y oportunidades que no encontrarás en ningún otro lugar.",
